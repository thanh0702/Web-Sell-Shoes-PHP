...
?>
  ...
  <?php
  echo '<H2> Hồ sơ của tôi: ' . htmlspecialchars($_SESSION['username']) . '</H2>';
  ?>
...
<div class="account-section">
    <div class="account-info">
        ...
        <p>Đây là thông tin tài khoản của bạn. Bạn có thể thay đổi tên tài khoản và mật khẩu ở bên phải.</p>
    </div>
    <div class="edit-profile-user">
        <h3>Chỉnh sửa Tên tài khoản và Mật khẩu</h3>
        
        <form action="update_credentials.php" method="POST" class="profile-user-form">
            <label for="username">Username mới:</label>
            <input type="text" id="username" name="username" placeholder="Nhập username mới" required>
